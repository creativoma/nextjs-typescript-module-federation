  ...
  },
  {
    ...
    icon: function FacebookIcon() {
      return (
        ...
        >
          <path fill="none" d="M0 0h24v24H0z" />
          <path d="M21 3H3a1 1 0 0 0-1 1v18a1 1 0 0 0 1 1h9v-9h-3v-3h3V8.5A2.5 2.5 0 0 1 15.5 6H18V3z" />
        </svg>
      );
    },
  },
...
const WebsiteAnalytics: React.FC = () => {
  return (
    <DashboardLayout title="Website Analytics">
      <Card className="max-w mb-6">
